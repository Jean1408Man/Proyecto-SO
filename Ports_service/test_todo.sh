...
PID2=$!
sleep 2
./bin/escane > tests/out_31337.out
kill $PID2
echo "[✓] Resultado esperado:"
...
PID3=$!
sleep 2
./bin/escane > tests/out_25_nc.out
sudo kill $PID3
echo "[✓] Resultado esperado:"
...
PID5=$!
sleep 2
./bin/escane > tests/out_80_nc.out
sudo kill $PID5
echo "[✓] Resultado esperado:"
